  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const formData = {
        ...
        // Children (only include those with names)
        children: children.filter(child => child.name),

        // Household Members (only include those with names)
        ...
        <div className="bgp-card">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-bgp-dark border-b pb-2">Your Information</h2>
              ...
              <div>
                <div className="flex justify-between items-center mb-3">
                  <div>
                    <h3 className="text-lg font-semibold text-bgp-dark">Household Members</h3>
                  ...
                  <div className="space-y-4">
                    {householdMembers.map((member, index) => (
                      <div key={index} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                        <div className="flex justify-between items-center mb-3">
                          <h4 className="font-medium text-bgp-dark">Household Member {index + 1}</h4>
                          <button
                            type="button"
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-bgp-dark border-b pb-2 mb-4">
              ...
              {/* Skills and Talents */}
              <div>
                <h3 className="text-lg font-semibold text-bgp-dark mb-2">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    />
                    <label htmlFor="photo_consent_yes" className="text-sm text-gray-700 cursor-pointer">
                  ...
                  <div className="flex items-start space-x-3">
                    <input
                      ...
                      id="photo_consent_no"
                    />
                    <label htmlFor="photo_consent_no" className="text-sm text-gray-700 cursor-pointer">
                  ...
                  {hasChildren && (
                    <>
                      <div className="flex items-start space-x-3">
                        ...
                        />
                        <label htmlFor="children_consent_yes" className="text-sm text-gray-700 cursor-pointer">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        />
                        <label htmlFor="children_consent_no" className="text-sm text-gray-700 cursor-pointer">
                      ...
                      <div className="flex items-start space-x-3 mt-4">
                        <input
                          ...
                          id="parental_consent"
                        />
                        <label htmlFor="parental_consent" className="text-sm text-gray-700 cursor-pointer">
              ...
              <div className="flex items-start space-x-3">
                ...
                />
                <label htmlFor="social_media_consent" className="text-sm text-gray-700 cursor-pointer">
